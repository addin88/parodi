        ...
        <div class="navbar navbar-main navbar-primary navbar-fixed-top" role="navigation">
            <div class="container-fluid">
                <div class="navbar-header">
                    <a href="<?php echo base_url();?>assets/#sidebar-menu" data-effect="st-effect-1" data-toggle="sidebar-menu" class="toggle pull-left visible-xs"><i class="fa fa-ellipsis-v"></i></a>
                    ...
                    <a href="<?php echo base_url();?>assets/#sidebar-chat" data-toggle="sidebar-menu" data-effect="st-effect-1" class="toggle pull-right visible-xs"><i class="fa fa-comments"></i></a>
                    <a class="navbar-brand" href="<?php echo base_url();?>assets/index.html">ThemeKit</a>
                </div>
                ...
                <div class="collapse navbar-collapse" id="main-nav">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown">
                            <a href="<?php echo base_url();?>assets/#" class="dropdown-toggle" data-toggle="dropdown">Pages <span class="caret"></span></a>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="hidden-xs">
                            <a href="<?php echo base_url();?>assets/#sidebar-chat" data-toggle="sidebar-menu" data-effect="st-effect-1">
                                <i class="fa fa-comments"></i>
                            </a>
                        </li>
                        <!-- User -->
                        <li class="dropdown">
                            <a href="<?php echo base_url();?>assets/#" class="dropdown-toggle user" data-toggle="dropdown"> <img src="<?php echo base_url()?>assets/images/people/110/guy-5.jpg" alt="Bill" class="img-circle" width="40" /> Bill <span class="caret"></span>
                            </a>
                            <ul class="dropdown-menu" role="menu">
                                <li><a href="<?php echo base_url();?>assets/user-private-profile.html">Profile</a>
                                </li>
                                ...
                                <li><a href="<?php echo base_url();?>assets/login.html">Logout</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
        ...
        <div class="sidebar left sidebar-size-2 sidebar-offset-0 sidebar-visible-desktop sidebar-visible-mobile sidebar-skin-dark" id="sidebar-menu">
            <div data-scrollable>
                <div class="sidebar-block">
                    <div class="profile"> <img src="<?php echo base_url()?>assets/images/people/110/guy-6.jpg" alt="people" class="img-circle" />
                        <h4>Adrian D.</h4>
                    </div>
                </div>
                ...
                <div class="sidebar-block">
                    <ul class="list-about">
                        ...
                        <li><i class="fa fa-link"></i> <a href="<?php echo base_url();?>assets/#">www.mosaicpro.biz</a>
                        </li>
                        <li><i class="fa fa-twitter"></i> <a href="<?php echo base_url();?>assets/#">/mosaicprobiz</a>
                        </li>
                    </ul>
                </div>
                ...
                <div class="sidebar-block">
                    <div class="sidebar-photos">
                        <ul>
                            <li>
                                <a href="<?php echo base_url();?>assets/#"> <img src="<?php echo base_url()?>assets/images/place1.jpg" alt="people" />
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo base_url();?>assets/#"> <img src="<?php echo base_url()?>assets/images/place2.jpg" alt="people" />
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo base_url();?>assets/#"> <img src="<?php echo base_url()?>assets/images/place3.jpg" alt="people" />
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo base_url();?>assets/#"> <img src="<?php echo base_url()?>assets/images/food1.jpg" alt="people" />
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo base_url();?>assets/#"> <img src="<?php echo base_url()?>assets/images/food1.jpg" alt="people" />
                        ...
                        <a href="<?php echo base_url();?>assets/#" class="btn btn-primary btn-xs">view all</a>
                    </div>
                </div>
                        ...
                        <ul>
                            ...
                            <i class="fa fa-fw fa-bell"></i>
                                ...
                                <div class="media-body">
                                    <a href="<?php echo base_url();?>assets/#" class="text-white">Adrian</a> just logged in
                            ...
                            <i class="fa fa-fw fa-bell"></i>
                                ...
                                <div class="media-body">
                                    <a href="<?php echo base_url();?>assets/#" class="text-white">Adrian</a> just added <a href="<?php echo base_url();?>assets/#" class="text-white">mosaicpro</a> as their office
                                    <span class="time">2 min ago</span>
                                </div>
                            </li>
                            <li class="media">
        ...
        <div class="sidebar sidebar-chat right sidebar-size-2 sidebar-offset-0 chat-skin-white" id=sidebar-chat>
            <div class="split-vertical">
                ...
                <ul class="chat-filter nav nav-pills ">
                    <li class="active"><a href="<?php echo base_url();?>assets/#" data-target="li">All</a>
                    </li>
                    <li><a href="<?php echo base_url();?>assets/#" data-target=".online">Online</a>
                    </li>
                    <li><a href="<?php echo base_url();?>assets/#" data-target=".offline">Offline</a>
                    </li>
                </ul>
                            ...
                            <ul class="chat-contacts">
                                <li class="online" data-user-id="1">
                                    <a href="<?php echo base_url();?>assets/#">
                                        <div class="media">
                                            <div class="pull-left">
                                                <span class="status"></span> <img src="<?php echo base_url()?>assets/images/people/110/guy-6.jpg" width="40" class="img-circle" />
                                            </div>
                                            <div class="media-body">
                                ...
                                <li class="online away" data-user-id="2">
                                    <a href="<?php echo base_url();?>assets/#">
                                        <div class="media">
                                            <div class="pull-left">
                                                <span class="status"></span> <img src="<?php echo base_url()?>assets/images/people/110/woman-5.jpg" width="40" class="img-circle" />
                                            </div>
                                            <div class="media-body">
                                ...
                                <li class="online" data-user-id="3">
                                    <a href="<?php echo base_url();?>assets/#">
                                        <div class="media">
                                            <div class="pull-left ">
                                                <span class="status"></span> <img src="<?php echo base_url()?>assets/images/people/110/guy-3.jpg" width="40" class="img-circle" />
                                            </div>
                                            <div class="media-body">
                                ...
                                <li class="offline" data-user-id="4">
                                    <a href="<?php echo base_url();?>assets/#">
                                        <div class="media">
                                            <div class="pull-left"> <img src="<?php echo base_url()?>assets/images/people/110/woman-6.jpg" width="40" class="img-circle" />
                                            </div>
                                            <div class="media-body">
                                ...
                                <li class="offline" data-user-id="5">
                                    <a href="<?php echo base_url();?>assets/#">
                                        <div class="media">
                                            <div class="pull-left"> <img src="<?php echo base_url()?>assets/images/people/110/woman-7.jpg" width="40" class="img-circle" />
                                            </div>
                                            <div class="media-body">
                                ...
                                <li class="online" data-user-id="6">
                                    <a href="<?php echo base_url();?>assets/#">
                                        <div class="media">
                                            <div class="pull-left">
                                                <span class="status"></span> <img src="<?php echo base_url()?>assets/images/people/110/guy-4.jpg" width="40" class="img-circle" />
                                            </div>
                                            <div class="media-body">
                                ...
                                <li class="online away" data-user-id="7">
                                    <a href="<?php echo base_url();?>assets/#">
                                        <div class="media">
                                            <div class="pull-left">
                                                <span class="status"></span> <img src="<?php echo base_url()?>assets/images/people/110/woman-6.jpg" width="40" class="img-circle" />
                                            </div>
                                            <div class="media-body">
                                ...
                                <li class="offline" data-user-id="8">
                                    <a href="<?php echo base_url();?>assets/#">
                                        <div class="media">
                                            <div class="pull-left">
                                                <span class="status"></span> <img src="<?php echo base_url()?>assets/images/people/110/woman-8.jpg" width="40" class="img-circle" />
                                            </div>
                                            <div class="media-body">
                                ...
                                <li class="online away" data-user-id="9">
                                    <a href="<?php echo base_url();?>assets/#">
                                        <div class="media">
                                            <div class="pull-left">
                                                <span class="status"></span> <img src="<?php echo base_url()?>assets/images/people/110/woman-9.jpg" width="40" class="img-circle" />
                                            </div>
                                            <div class="media-body">
        ...
        <script id="chat-window-template" type="text/x-handlebars-template">
            <div class="panel panel-default">
                <div class="panel-heading" data-toggle="chat-collapse" data-target="#chat-bill">
                    <a href="<?php echo base_url();?>assets/#" class="close"><i class="fa fa-times"></i></a>
                    <a href="<?php echo base_url();?>assets/#">
        ...
        <div class="st-pusher" id="content">
            ...
            <div class="st-content">
                ...
                <div class="st-content-inner">
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="collapse navbar-collapse" id="subnav">
                                ...
                                <ul class="nav navbar-nav navbar-right hidden-xs">
                                    <li><a href="<?php echo base_url();?>assets/#" data-toggle="chat-box">Chat <i class="fa fa-fw fa-comment-o"></i></a>
                                    </li>
                                </ul>
                            </div>
                            <!-- /.navbar-collapse -->
                    ...
                    <div class="cover overlay cover-image-full height-300-lg"> <img src="<?php echo base_url()?>assets/images/profile-cover.jpg" alt="cover" />
                        <div class="overlay overlay-full">
                            <div class="v-top">
                                <a href="<?php echo base_url();?>assets/#" class="btn btn-cover"><i class="fa fa-pencil"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="container-fluid">
                        <div class="timeline row" data-toggle="isotope">
                                ...
                                <div class="timeline-block">
                                    <div class="panel panel-default share clearfix-xs">
                                        ...
                                        <div class="panel-footer share-buttons">
                                            <a href="<?php echo base_url();?>assets/#"><i class="fa fa-map-marker"></i></a>
                                            <a href="<?php echo base_url();?>assets/#"><i class="fa fa-photo"></i></a>
                                            <a href="<?php echo base_url();?>assets/#"><i class="fa fa-video-camera"></i></a>
                                            <button type="submit" class="btn btn-primary btn-xs pull-right display-none" href="<?php echo base_url();?>assets/#">Post</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xs-12 col-md-6 col-lg-4 item">
                                <div class="timeline-block">
                                    <div class="panel panel-default relative"> <img src="<?php echo base_url()?>assets/images/place2-full.jpg" alt="place" class="img-responsive">
                                        ...
                                        <div class="panel-body"> <img src="<?php echo base_url()?>assets/images/people/50/guy-2.jpg" alt="people" class="img-circle" /> <img src="<?php echo base_url()?>assets/images/people/50/woman-2.jpg" alt="people" class="img-circle" /> <img src="<?php echo base_url()?>assets/images/people/50/guy-3.jpg" alt="people" class="img-circle" /> <img src="<?php echo base_url()?>assets/images/people/50/woman-3.jpg" alt="people" class="img-circle" />
                                            <a href="<?php echo base_url();?>assets/#" class="user-count-circle">12+</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="timeline-block">
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            <div class="media">
                                                <a href="<?php echo base_url();?>assets/#" class="pull-left"> <img src="<?php echo base_url()?>assets/images/people/50/woman-5.jpg" class="media-object">
                                                </a>
                                                <div class="media-body">
                                                    <a href="<?php echo base_url();?>assets/#" class="pull-right text-muted"><i class="icon-reply-all-fill fa fa-2x "></i></a>
                                                    <a href="<?php echo base_url();?>assets/#">Mary</a>
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="timeline-added-images"> <img src="<?php echo base_url()?>assets/images/social/100/1.jpg" width="80" alt="photo" /> <img src="<?php echo base_url()?>assets/images/social/100/2.jpg" width="80" alt="photo" /> <img src="<?php echo base_url()?>assets/images/social/100/3.jpg" width="80" alt="photo" />
                                            </div>
                                        </div>
                                        <div class="view-all-comments"><a href="<?php echo base_url();?>assets/#"><i class="fa fa-comments-o"></i> View all</a> 10 comments</div>
                                        <ul class="comments">
                                            <li>
                                                <div class="media">
                                                    <a href="<?php echo base_url();?>assets/#" class="pull-left"> <img src="<?php echo base_url()?>assets/images/people/50/guy-5.jpg" class="media-object">
                                                    </a>
                                                    <div class="pull-right dropdown" data-show-hover="li">
                                                        <a href="<?php echo base_url();?>assets/#" data-toggle="dropdown" class="toggle-button">
                                                            <i class="fa fa-pencil"></i>
                                                        </a>
                                                        <ul class="dropdown-menu" role="menu">
                                                            <li><a href="<?php echo base_url();?>assets/#">Edit</a>
                                                            </li>
                                                            <li><a href="<?php echo base_url();?>assets/#">Delete</a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                    <div class="media-body">
                                                        <a href="<?php echo base_url();?>assets/#" class="comment-author">Bill D.</a>
                                            ...
                                            <li>
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a href="<?php echo base_url();?>assets/#" class="comment-author">Mary</a>
                   ...
                   <a href="<?php echo base_url();?>assets/#" class="btn btn-default"><i class="fa fa-photo"></i></a>
                </span>
                                                </div>
                                            </li>
                                        </ul>
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    <a href="<?php echo base_url();?>assets/#" class="pull-right text-muted"><i class="icon-reply-all-fill fa fa-2x "></i></a>
                                                    <a href="<?php echo base_url();?>assets/#">Bill</a>
                                                    <span>on 15th January, 2014</span>
                                                </div>
                                            </div>
                                        </div> <img src="<?php echo base_url()?>assets/images/place1-full.jpg" class="img-responsive">
                                        <ul class="comments">
                                            <li>
                                                <div class="media">
                                                    <a href="<?php echo base_url();?>assets/#" class="pull-left"> <img src="<?php echo base_url()?>assets/images/people/50/woman-5.jpg" class="media-object">
                                ...
                                <div class="timeline-block">
                                    <div class="panel panel-default">
                                        ...
                                        <div class="panel-body text-muted">
                                            <i class="fa fa-map-marker"></i> Was in <a href="<?php echo base_url();?>assets/#">Brooklyn, New York</a>
                                        </div>
                                ...
                                <div class="timeline-block">
                                    <div class="panel panel-default">
                                        ...
                                        <div class="embed-responsive embed-responsive-4by3">
                                            <iframe class="embed-responsive-item" ser="<?php echo base_url()?>assets/http://player.vimeo.com/video/50522981?title=0&amp;byline=0&amp;portrait=0&amp;color=ffffff"></iframe>
                                        </div>
                                        <div class="view-all-comments"><i class="fa fa-comments-o"></i> Be the first to comment</div>
                                        <ul class="comments">
                                            <li class="comment-form">
                            ...
                            <div class="col-xs-12 col-md-6 col-lg-4 item">
                                <div class="timeline-block">
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            <div class="media">
                                                <a href="<?php echo base_url();?>assets/#" class="pull-left"> <img src="<?php echo base_url()?>assets/images/people/50/woman-4.jpg" class="media-object">
                                                </a>
                                                <div class="media-body">
                                                    <a href="<?php echo base_url();?>assets/#" class="pull-right text-muted"><i class="icon-reply-all-fill fa fa-2x "></i></a>
                                                    <a href="<?php echo base_url();?>assets/#">Michelle</a>
                                                    <span>on 15th January, 2014</span>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="timeline-block">
                                    <div class="panel panel-default">
                                        <div class="profile-block">
                                            <div class="cover overlay cover-image-full"> <img src="<?php echo base_url()?>assets/images/place1-full.jpg" alt="cover">
                                                <div class="overlay overlay-full overlay-bg-black">
                                                    <div class="v-top v-spacing-2">
                                                        <a href="<?php echo base_url();?>assets/#" class="icon pull-right">
                                                            <i class="fa fa-comment"></i>
                                                        </a>
                                                        <a href="<?php echo base_url();?>assets/#" class="text-h3">Adrian Demian</a>
                                                        <p>User Interface Designer</p>
                                                    </div>
                                                    <div class="v-bottom">
                                                        <a href="<?php echo base_url();?>assets/#"> <img src="<?php echo base_url()?>assets/images/people/110/guy-6.jpg" alt="people" class="img-circle avatar" />
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="timeline-block">
                                    <div class="panel panel-default event">
                                        ...
                                        <ul class="icon-list icon-list-block">
                                            ...
                                            <li><i class="fa fa-users"></i> 9 Attendees <a href="<?php echo base_url();?>assets/#" class="btn btn-primary btn-stroke btn-xs pull-right">Attend</a>
                                            </li>
                                        </ul>
                                        <ul class="img-grid">
                                            <li>
                                                <a href="<?php echo base_url();?>assets/#"> <img src="<?php echo base_url()?>assets/images/people/110/guy-6.jpg" alt="people" class="img-responsive" />
                                                </a>
                                            </li>
                                            <li>
                                                <a href="<?php echo base_url();?>assets/#"> <img src="<?php echo base_url()?>assets/images/people/110/woman-3.jpg" alt="people" class="img-responsive" />
                                                </a>
                                            </li>
                                            <li>
                                                <a href="<?php echo base_url();?>assets/#"> <img src="<?php echo base_url()?>assets/images/people/110/guy-2.jpg" alt="people" class="img-responsive" />
                                                </a>
                                            </li>
                                            <li>
                                                <a href="<?php echo base_url();?>assets/#"> <img src="<?php echo base_url()?>assets/images/people/110/guy-9.jpg" alt="people" class="img-responsive" />
                                                </a>
                                            </li>
                                            <li>
                                                <a href="<?php echo base_url();?>assets/#"> <img src="<?php echo base_url()?>assets/images/people/110/woman-9.jpg" alt="people" class="img-responsive" />
                                                </a>
                                            </li>
                                            <li class="clearfix">
                                                <a href="<?php echo base_url();?>assets/#"> <img src="<?php echo base_url()?>assets/images/people/110/guy-4.jpg" alt="people" class="img-responsive" />
                                                </a>
                                            </li>
                                            <li>
                                                <a href="<?php echo base_url();?>assets/#"> <img src="<?php echo base_url()?>assets/images/people/110/guy-1.jpg" alt="people" class="img-responsive" />
                                                </a>
                                            </li>
                                            <li>
                                                <a href="<?php echo base_url();?>assets/#"> <img src="<?php echo base_url()?>assets/images/people/110/woman-4.jpg" alt="people" class="img-responsive" />
                                                </a>
                                            </li>
                                            <li>
                                                <a href="<?php echo base_url();?>assets/#"> <img src="<?php echo base_url()?>assets/images/people/110/guy-6.jpg" alt="people" class="img-responsive" />
                            ...
                            <div class="col-xs-12 col-md-6 col-lg-4 item">
                                <div class="timeline-block">
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            <div class="media">
                                                <a href="<?php echo base_url();?>assets/#" class="pull-left"> <img src="<?php echo base_url()?>assets/images/people/50/guy-2.jpg" class="media-object">
                                                </a>
                                                <div class="media-body">
                                                    <a href="<?php echo base_url();?>assets/#" class="pull-right text-muted"><i class="icon-reply-all-fill fa fa-2x "></i></a>
                                                    <a href="<?php echo base_url();?>assets/#">Jonathan</a>
                                                    <span>on 15th January, 2014</span>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="col-xs-12 col-md-6 col-lg-4 item">
                                <div class="timeline-block">
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            <div class="media">
                                                <div class="media-left">
                                                    <a href="<?php echo base_url();?>assets/#"> <img src="<?php echo base_url()?>assets/images/people/50/guy-2.jpg" class="media-object">
                                                    </a>
                                                </div>
                                                <div class="media-body">
                                                    <a href="<?php echo base_url();?>assets/#" class="pull-right text-muted"><i class="icon-reply-all-fill fa fa-2x "></i></a>
                                        ...
                                        <div class="panel-body">
                                            <div class="boxed">
                                                <a href="<?php echo base_url();?>assets/#" class="h4 margin-none">Vegetarian Pizza</a>
                                                <div>
                                                ...
                                                <div class="media">
                                                    <div class="media-left">
                                                        <a href="<?php echo base_url();?>assets/#"> <img src="<?php echo base_url()?>assets/images/food1.jpg" alt="" width="80" class="media-object">
                                                        </a>
                                                    </div>
                                                    <div class="media-body">
